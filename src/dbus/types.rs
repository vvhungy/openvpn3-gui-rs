//! D-Bus wire type definitions for OpenVPN3
//!
//! Raw enums that map directly to the OpenVPN3 Linux client D-Bus API values.
//! Application-level status logic lives in [`super::session_status`].

use zbus::zvariant::Type;

// Re-export so existing `use crate::dbus::types::SessionStatus` paths keep working
pub use super::session_status::SessionStatus;
