...
impl SessionStatus {
    ...
    pub fn is_error(&self) -> bool {
        self.major == StatusMajor::CfgError
            || (self.major == StatusMajor::Connection && matches!(self.minor,
                StatusMinor::CfgError | StatusMinor::CfgInlineMissing |
                StatusMinor::ConnFailed | StatusMinor::ConnAuthFailed
            ))
            || (self.major == StatusMajor::Process && matches!(self.minor,
...
mod tests {
    ...
    fn test_client_attention_type() {
        ...
        assert_eq!(ClientAttentionType::from_u32(99), ClientAttentionType::Unset);
    }
